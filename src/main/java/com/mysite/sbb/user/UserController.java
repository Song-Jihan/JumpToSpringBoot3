...
public class UserController {
	...
	@GetMapping("/profile")
	public String profile(UserUpdateForm userUpdateForm,@RequestParam(value="questionPage", defaultValue="0") int questionPage,
			@RequestParam(value="answerPage", defaultValue="0") int answerPage,
			Model model,Principal principal) {
		SiteUser siteuser = this.userService.getUser(principal.getName());
		Page<Question> questionPaging = this.questionService.getListByAuthor(questionPage, siteuser);
		Page<Answer> answerPaging = this.answerService.getListByAuthor(answerPage, siteuser);
	...
	public String changePassword(@Valid @ModelAttribute UserUpdateForm userUpdateForm, BindingResult bindingResult, Principal principal, Model model) {

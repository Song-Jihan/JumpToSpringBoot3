...
public class CommentController {
	...
	public String createCommentOnQuestion(Model model, @PathVariable("id") Integer id,
	...
	public String createCommentOnAnswer(Model model, @PathVariable("id") Integer id,
		...
		return String.format("redirect:/question/detail/%s#comment_%s", comment.getAnswer().getQuestion().getId(),
				comment.getAnswer());
	}
	...
	public String modifyCommentOnAnswer(@Valid AnswerForm answerForm, BindingResult bindingResult,
		...
		this.commentService.modify(comment, answerForm.getContent());
		return String.format("redirect:/question/detail/%s#answer_%s", comment.getAnswer().getQuestion().getId(),
				comment.getId());
	}
